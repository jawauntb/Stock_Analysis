...
class AlphaVantageShortcut(object):

    """This class allows you to make manual calls to the Alpha Vantage API.
    It allows you to pass an arbitrary number of parameters into dictionary.
    That dictionary is used to hold the values of each optional or required
    parameter used with the API. Parameters can be added, updated and deleted.
    Additionally, the class holds a response object that can be used to hold
    the results of HTTP requests to the API, and can be converted into plain text
